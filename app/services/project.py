"""
Project service providing canonical project data for all routes.
"""
...
class ProjectService:
    ...
    def get_featured(self, limit: int | None = None) -> list[Project]:
        """Return featured projects sorted by creation date."""
    ...
    def get_sorted(self) -> list[Project]:
        """Return all projects sorted by featured first, then by creation date."""
    ...
    def get_related(self, project_id: int, limit: int = 3) -> list[Project]:
        """Return related projects (same category, different ID)."""
    ...
    @staticmethod
    def _build_projects() -> dict[int, Project]:
